function traerReporteStatus(){
    $.ajax({
        url:"http://192.18.130.127:8080/api/Reservation/report-status",
        type:"GET",
        datatype:"JSON",
...
function traerReportesFechas(){
    $.ajax({
        url:"http://192.18.130.127:8080/api/Reservation/report-dates/{dateOne}/{dateTwo}",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta)
...
function traerReportesClientes(){
    ...
    $.ajax({
        url:"http://192.18.130.127:8080/api/Reservation/report-clients",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta)
